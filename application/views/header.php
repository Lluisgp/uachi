...
<div class="row">
    <div class="col-sm-8">    
        <form role="form" class="form-inline" method="post" action="<?php echo base_url('media/media_search'); ?>"> <p>&nbsp;&nbsp;</p> 
            ...
            <p>&nbsp;&nbsp;</p> 
            <input class="btn btn-danger" type="submit" value="Busca" name="Cercabt"/></form>
    </div> 
    <div class="col-sm-4"style="text-align:right">
        ...
        ?><a href="<?php echo base_url('user'); ?>">
            <?php
            $filename = 'pic/' . $this->session->userdata('user_id') . '.jpg';
            ...
            <?php } else { ?>
                <img  style="-moz-border-radius: 225px; border-radius: 225px; 
                      -webkit-border-radius: 225px; background-color: red; height: 53px; width: 53px; " src="<?php echo base_url() ?>pic/<?php echo $this->session->userdata('user_id') ?>.jpg"></img>
                  <?php } ?>
        </a>
    </div>
</div>
