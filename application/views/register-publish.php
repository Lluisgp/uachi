                    ...
                    <div class="col-md-4 col-md-offset-4" style="margin:auto;"><!--col-md-4 is used to create the no of colums in the grid also use for medimum and large devices-->
                        <div class="login-panel panel panel-success">
                            ...
                            <div class="panel-body">
                                ...
                                $permissions = ['email', 'public_profile', 'user_location']; // Optional permissions
                                $loginUrl = $helper->getLoginUrl('http://uachit.260mb.net/fb-callback.php', $permissions);

                                echo '<center><a href="' . htmlspecialchars($loginUrl) . '">O entra amb el Facebook!</a></center>';
                                ?>
