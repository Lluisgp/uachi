...
<p>&nbsp;&nbsp;</p>                
              <input type="text" class="center-block form-control input-lg" title="Cercar" name="cerca" placeholder="Introdueïx el que vols cercar...">              
              <span class="input-group-btn"><input class="btn btn-lg btn-primary" type="submit" value="Cerca" name="Cercabt"></span>
